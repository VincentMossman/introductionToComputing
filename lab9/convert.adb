...
procedure Convert is
   ...
   -- Preconditions : None
   begin
      return Fahrenheit (((9.0 / 5.0) * Degrees) + 32.0);
   end To_Fahrenheit;
   ...
   begin
      ...
      for Degree in 0 .. 9 loop
         Centigrade_Temperature := First + Centigrade (Degree);
   ...
   begin
      ...
      for Count in 1 .. Column_Width * 10 loop
         Put ('-');
      end loop;
      New_Line;
   ...
   begin
      ...
      loop
         ...
         exit when Value rem 10 = 0 and Value >= 0;

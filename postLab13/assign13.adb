...
--   2. The name is in the form Last Name comma First Name
   ...
   --                     Result is zero
      ...
      Result : Natural;   -- Index of the first occurence

   begin   -- Index

      Result := Source'First;

      -- Loop determines index of first occurrence of Pattern in Source
      -- Each iteration, checks one value
      loop
   ...
   -- Postconditions : Name contains blank padded first and last names
      ...
      Whole_Name     : Name_String;   -- Whole name of person
      Length         : Natural;       -- Last good character
      Comma_Position : Natural;       -- Position of comma
   ...
   --                  If no elements are read, Last is Class'First - 1
      ...
      File      : Ada.Text_IO.File_Type; -- File of student information
      File_Name : File_String;           -- Name of file
      Length    : Natural;               -- Last good character in File_Name
   ...
   -- Procedure displays a students name
   --
   -- Preconditions  : None
   --
   -- Postconditions : Student's name is displayed

      Blank_Pos : Natural;   -- Position of blank character
...
begin   -- Assign13
   ...
   loop
      ...
      exit Lucky_Num_Search when Lucky_Number_Search not in
           Integer (Lucky_Range'First) .. Integer (Lucky_Range'Last);

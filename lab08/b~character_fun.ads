...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_character_fun" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#ebb50c2f#;
   pragma Export (C, u00001, "character_funB");
   ...
   u00006 : constant Version_32 := 16#6239f067#;
   ...
   u00024 : constant Version_32 := 16#a505d3ce#;
   pragma Export (C, u00024, "system__storage_elementsS");
   u00025 : constant Version_32 := 16#5ea2bd7b#;
   pragma Export (C, u00025, "ada__exceptionsB");
   u00026 : constant Version_32 := 16#6380a30f#;
   ...
   u00030 : constant Version_32 := 16#533666e1#;
   ...
   u00032 : constant Version_32 := 16#67b88b82#;
   ...
   u00077 : constant Version_32 := 16#103addc6#;
   ...
   u00080 : constant Version_32 := 16#29899d4e#;
   pragma Export (C, u00080, "interfaces__cS");
   u00081 : constant Version_32 := 16#507533cc#;
   ...
   u00083 : constant Version_32 := 16#d6bc4ecc#;
   pragma Export (C, u00083, "system__crtl__runtimeS");
   u00084 : constant Version_32 := 16#1eab0e09#;
   pragma Export (C, u00084, "system__img_enum_newB");
   u00085 : constant Version_32 := 16#d8cf65a6#;
   pragma Export (C, u00085, "system__img_enum_newS");
   u00086 : constant Version_32 := 16#f6ee85e9#;
   pragma Export (C, u00086, "system__os_libB");
   u00087 : constant Version_32 := 16#89dce9aa#;
   pragma Export (C, u00087, "system__os_libS");
   u00088 : constant Version_32 := 16#4cd8aca0#;
   pragma Export (C, u00088, "system__stringsB");
   u00089 : constant Version_32 := 16#e822e492#;
   pragma Export (C, u00089, "system__stringsS");
   u00090 : constant Version_32 := 16#782cc428#;
   pragma Export (C, u00090, "system__file_control_blockS");
   u00091 : constant Version_32 := 16#91d2300e#;
   pragma Export (C, u00091, "system__finalization_mastersB");
   u00092 : constant Version_32 := 16#353d027a#;
   pragma Export (C, u00092, "system__finalization_mastersS");
   u00093 : constant Version_32 := 16#57a37a42#;
   pragma Export (C, u00093, "system__address_imageB");
   u00094 : constant Version_32 := 16#fe24336c#;
   pragma Export (C, u00094, "system__address_imageS");
   u00095 : constant Version_32 := 16#7268f812#;
   pragma Export (C, u00095, "system__img_boolB");
   u00096 : constant Version_32 := 16#aa11dfbd#;
   pragma Export (C, u00096, "system__img_boolS");
   u00097 : constant Version_32 := 16#d7aac20c#;
   pragma Export (C, u00097, "system__ioB");
   u00098 : constant Version_32 := 16#c18a5919#;
   pragma Export (C, u00098, "system__ioS");
   u00099 : constant Version_32 := 16#a7a37cb6#;
   pragma Export (C, u00099, "system__storage_poolsB");
   u00100 : constant Version_32 := 16#8c66b13b#;
   pragma Export (C, u00100, "system__storage_poolsS");
   u00101 : constant Version_32 := 16#ba5d60c7#;
   pragma Export (C, u00101, "system__pool_globalB");
   u00102 : constant Version_32 := 16#d56df0a6#;
   pragma Export (C, u00102, "system__pool_globalS");
   u00103 : constant Version_32 := 16#742a8355#;
   pragma Export (C, u00103, "system__memoryB");
   u00104 : constant Version_32 := 16#95431243#;
   pragma Export (C, u00104, "system__memoryS");
   u00105 : constant Version_32 := 16#1fd820b1#;
   pragma Export (C, u00105, "system__storage_pools__subpoolsB");
   u00106 : constant Version_32 := 16#951e0de9#;
   pragma Export (C, u00106, "system__storage_pools__subpoolsS");
   u00107 : constant Version_32 := 16#1777d351#;
   pragma Export (C, u00107, "system__storage_pools__subpools__finalizationB");
   u00108 : constant Version_32 := 16#12aaf1de#;
   pragma Export (C, u00108, "system__storage_pools__subpools__finalizationS");
   u00109 : constant Version_32 := 16#f6fdca1c#;
   pragma Export (C, u00109, "ada__text_io__integer_auxB");
   u00110 : constant Version_32 := 16#b9793d30#;
   pragma Export (C, u00110, "ada__text_io__integer_auxS");
   u00111 : constant Version_32 := 16#cd6ba629#;
   ...
   u00113 : constant Version_32 := 16#ef6c8032#;
   pragma Export (C, u00113, "system__img_biuB");
   u00114 : constant Version_32 := 16#f30b7a6d#;
   pragma Export (C, u00114, "system__img_biuS");
   u00115 : constant Version_32 := 16#10618bf9#;
   pragma Export (C, u00115, "system__img_llbB");
   u00116 : constant Version_32 := 16#b2cc6a93#;
   pragma Export (C, u00116, "system__img_llbS");
   u00117 : constant Version_32 := 16#9777733a#;
   pragma Export (C, u00117, "system__img_lliB");
   u00118 : constant Version_32 := 16#4e87fb87#;
   pragma Export (C, u00118, "system__img_lliS");
   u00119 : constant Version_32 := 16#f931f062#;
   pragma Export (C, u00119, "system__img_llwB");
   u00120 : constant Version_32 := 16#1ba04905#;
   pragma Export (C, u00120, "system__img_llwS");
   u00121 : constant Version_32 := 16#b532ff4e#;
   pragma Export (C, u00121, "system__img_wiuB");
   u00122 : constant Version_32 := 16#9d4afdff#;
   pragma Export (C, u00122, "system__img_wiuS");
   u00123 : constant Version_32 := 16#c31442ce#;
   pragma Export (C, u00123, "system__val_intB");
   u00124 : constant Version_32 := 16#176d8469#;
   pragma Export (C, u00124, "system__val_intS");
   u00125 : constant Version_32 := 16#d3757657#;
   pragma Export (C, u00125, "system__val_lliB");
   u00126 : constant Version_32 := 16#c5ec48f6#;
   pragma Export (C, u00126, "system__val_lliS");
   u00127 : constant Version_32 := 16#25c21d28#;
   pragma Export (C, u00127, "system__val_lluB");
   u00128 : constant Version_32 := 16#4fdba552#;

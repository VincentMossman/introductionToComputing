...
procedure Assign7 is
   ...
   begin   -- Process_Transactions
      ...
      -- Loop processes transactions in a user defined file
      -- Each iteration, processes one transaction
   ...
   begin   -- Process_Initial_Inventory
      ...
      -- Loop processes initial inventory from user defined file
      -- Each iteration, processes inventory for one type of candy

...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_imafaggot" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#11127141#;
   pragma Export (C, u00001, "imafaggotB");
   ...
   u00098 : constant Version_32 := 16#a4185caa#;

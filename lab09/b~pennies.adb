pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~pennies.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~pennies.adb");
with Ada.Exceptions;
...
package body ada_main is
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_pennies");
